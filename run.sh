...
# python test.py -cfg configs/deeplabv2_r101_adv.yaml --saveres OUTPUT_DIR results/adv_test_0206/ PSEUDO_DIR /home/admin_mcn/taint/dataset/cityscapes/soft_labels_namkd DATASETS.TEST cityscapes_train resume results/adv_test_0206/AsppFada-8.pth
